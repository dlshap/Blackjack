...
public class CopyOfBasicStrategy implements Strategy {

	private static Play[][] playForPairs = new Play[10][10];

	private CopyOfBasicStrategy() {
		super();
		buildPlayForPairs();
	}

	public static CopyOfBasicStrategy createBasicStrategy() {
		return new CopyOfBasicStrategy();
	}
